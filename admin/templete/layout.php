...
<head>
	...
	<?php
	//载入本文档的css文件
	if(file_exists(ADMIN_PATH.'css/'.$templete.'.css'))
	{
		echo '<link href="/admin/css/'.$templete.'.css" rel="stylesheet" type="text/css" />';
	}
	//载入需要的css文件
...
<body style="background-color: <?php echo Config::BG_COLOR; ?>;">
	<div class="main">
		...
		<div class="content"><?php include_once(ADMIN_PATH.'templete/'.$templete.'.php'); ?></div>
