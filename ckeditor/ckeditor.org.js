(function() {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getDocumentPosition:function(a) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var p = this.$.getBoundingClientRect(), u = c.$.documentElement, t = u.clientTop || e.$.clientTop || 0, y = u.clientLeft || e.$.clientLeft || 0, n = true;
                    if (CKEDITOR.env.ie) {
    ...
    (function() {
        function a(a, b) {
            ...
            if (this.current) d = this.current[q](false, l, i); else {
                if (a) d.type == CKEDITOR.NODE_ELEMENT && (d = p > 0 ? d.getChild(p - 1) :i(d, true) === false ? null :d.getPreviousSourceNode(true, l, i)); else {
                    d = f;
    ...
    (function() {
        ...
        var c = function(a) {
            ...
            if (e.type == CKEDITOR.NODE_TEXT) e = e.split(r); else if (e.getChildCount() > 0) if (r >= e.getChildCount()) {
    ...
    (function() {
            ...
            if (!a.match || a.match(c)) if (f || h(a, c)) {
                ...
                if (!d.allClasses) {
                    ...
                    if (a) if (a === true) a = true; else {
                        for (var e = 0, i = c.length, q; e < i; ++e) {
                            q = c[e];
                            f[q] || (f[q] = a(q));
                        }
                        a = false;
        ...
        var N = CKEDITOR.dtd, F = 1, Q = CKEDITOR.tools.copy, J = CKEDITOR.tools.trim, A = "cke-test", E = [ "", "p", "br", "div" ];
        ...
        CKEDITOR.filter.prototype = {
            allow:function(b, c, f) {
                ...
                var e, i;
                if (typeof b == "string") b = p(b); else if (b instanceof CKEDITOR.style) {
                ...
                a.forEach(function(a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (!b || !(a.name == "span" && ~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-"))) {
                            q = y(f, a, e, B);
                            if (q & F) k = true; else if (q & 2) return false;
                        }
        ...
        function p(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var i in c) {
                    ...
                    if (k && !a.lang[i]) {
                        k.split && (k = k.split(","));
                        if (CKEDITOR.tools.indexOf(k, a.langCode) >= 0) g = a.langCode; else {
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            proto:{
                addRules:function(a, c) {
                    var f;
                    if (typeof c == "number") f = c; else if (c && "priority" in c) f = c.priority;
    ...
    (function() {
        function a(a, e) {
            ...
            function q(a, f) {
                return function(e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (i = (typeof f == "function" ? f(e) :f) !== false) if (!r && !CKEDITOR.env.needsBrFiller && e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) i = false; else if (!r && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem)) i = false; else {
                            i = b(e);
            ...
            var s = {
                elements:{}
            }, r = e == "html", v = CKEDITOR.tools.extend({}, l), z;
    ...
    (function() {
        ...
        function b(a) {
            var b = a.name, d = a.element, e = a.elementMode, h = a.fire("uiSpace", {
                space:"top",
                html:""
    ...
    (function() {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto:{
                ...
                insertElementIntoRange:function(a, b) {
                    ...
                    var g, s;
                    if (f) for (;(g = b.getCommonAncestor(0, 1)) && (s = CKEDITOR.dtd[g.getName()]) && (!s || !s[e]); ) if (g.getName() in CKEDITOR.dtd.span) b.splitElement(g); else if (b.checkStartOfBlock() && b.checkEndOfBlock()) {
                        b.setStartBefore(g);
                        b.collapse(true);
                        g.remove();
        ...
        var p = CKEDITOR.dom.walker.bogus(), u = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi, t = CKEDITOR.dom.walker.whitespaces(true), y = CKEDITOR.dom.walker.bookmark(false, true);
        ...
        var n = function() {
            ...
            function d(b, c) {
                var e = [], f = b.getChildren(), l = f.count(), k, q = 0, g = h[c], s = !b.is(h.$inline) || b.is("br");
                for (s && e.push(" "); q < l; q++) {
                    k = f.getItem(q);
    ...
    (function() {
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            f.on("contentDom", function() {
                ...
                var i = f.document, k = CKEDITOR.document, g = f.editable(), h = i.getBody(), n = i.getDocumentElement(), m = g.isInline(), p, A;
        ...
        var w = typeof window.getSelection != "function", o = 1;
        CKEDITOR.dom.selection = function(a) {
            ...
            if (CKEDITOR.env.webkit) (c.type == "None" && this.document.getActive().equals(a) || c.type == "Caret" && c.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && h(a, c); else if (CKEDITOR.env.gecko) c && this.document.getActive().equals(a) && c.anchorNode && c.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT && h(a, c, true); else if (CKEDITOR.env.ie) {
                    ...
                    getNextRange:function(g) {
                        ...
                        if (h && a.length > 1) {
                            ...
                            if (g) for (var j = 0; a[d + j + 1]; ) {
                                for (var p = h.document, g = 0, m = p.getById(e[j].endNode), p = p.getById(e[j + 1].startNode); ;) {
...
*/
    ...
    (function() {
        ...
        function m(b, d, a) {
            ...
            "wysiwyg" == b.mode && (d || (d = b.activeEnterMode), b.elementPath().isContextFor("p") || (d = CKEDITOR.ENTER_BR, 
            a = 1), b.fire("saveSnapshot"), d == CKEDITOR.ENTER_BR ? p(b, d, null, a) :q(b, d, null, a), 
            b.fire("saveSnapshot"));
        }
        function r(b) {
        ...
        CKEDITOR.plugins.enterkey = {
            enterBlock:function(b, d, a, h) {
                if (a = a || r(b)) {
                    ...
                    if (i && k) {
                        if (c && (c.is("li") || c.getParent().is("li"))) {
                            ...
                            if (e.is("li")) if (h || n) c[h ? "insertBefore" :"insertAfter"](e); else c.breakParent(e); else {
                                if (b) if (j.block.is("li") ? (e = f.createElement(d == CKEDITOR.ENTER_P ? "p" :"div"), 
                                m && e.setAttribute("dir", i), o && e.setAttribute("style", o), k && e.setAttribute("class", k), 
                                c.moveChildren(e)) :e = j.block, h || n) e[h ? "insertBefore" :"insertAfter"](a); else c.breakParent(a), 
                                e.insertAfter(a); else if (c.appendBogus(!0), h || n) for (;f = c[h ? "getFirst" :"getLast"](); ) f[h ? "insertBefore" :"insertAfter"](a); else for (c.breakParent(a); f = c.getLast(); ) f.insertAfter(a);
                                c.remove();
                            }
                            l.selectBookmarks(g);
                            return;
                    ...
                    if (i = a.splitBlock(l)) {
                        ...
                        j = i.wasStartOfBlock;
                        b = i.wasEndOfBlock;
                        if (c) g = c.getParent(), g.is("li") && (c.breakParent(g), c.move(c.getNext(), 1)); else if (d && (g = d.getParent()) && g.is("li")) d.breakParent(g), 
                        g = d.getNext(), a.moveToElementEditStart(g), d.move(d.getPrevious());
                        if (!j && !b) c.is("li") && (e = a.clone(), e.selectNodeContents(c), e = new CKEDITOR.dom.walker(e), 
                        ...
                        c && a.moveToElementEditStart(c); else {
                            ...
                            e ? h && !e.is("li") && e.renameNode(l) :g && g.is("li") ? e = g :(e = f.createElement(l), 
            ...
            enterBr:function(b, d, a, h) {
                if (a = a || r(b)) {
                    ...
                    !h && "li" == c ? q(b, d, a, h) :(!h && i && s.test(c) ? (i = j.getDirection()) ? (f = f.createElement("div"), 
                    f.setAttribute("dir", i), f.insertAfter(j), a.setStart(f, 0)) :(f.createElement("br").insertAfter(j), 
                    CKEDITOR.env.gecko && f.createText("").insertAfter(j), a.setStartAt(j.getNext(), CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START :CKEDITOR.POSITION_AFTER_START)) :(b = "pre" == c && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ? f.createText("\r") :f.createElement("br"), 
                    a.deleteContents(), a.insertNode(b), CKEDITOR.env.needsBrFiller ? (f.createText("").insertAfter(b), 
                    i && (j || k.blockLimit).appendBogus(), b.getNext().$.nodeValue = "", a.setStartAt(b.getNext(), CKEDITOR.POSITION_AFTER_START)) :a.setStartAt(b, CKEDITOR.POSITION_AFTER_END)), 
    ...
    (function() {
        function i(a) {
            var j = a.config, m = a.fire("uiSpace", {
                ...
                return function(d) {
                    if (i = a.editable()) if (d && "focus" == d.name && b.show(), b.removeStyle("left"), 
                    b.removeStyle("right"), l = b.getClientRect(), c = i.getClientRect(), h = g.getViewPaneSize(), 
                    n = l.height, r = "pageXOffset" in g.$ ? g.$.pageXOffset :CKEDITOR.document.$.documentElement.scrollLeft, 
                    k) {
                        ...
                        l.width > h.width ? (d = "left", f = 0) :(f = "left" == d ? 0 < c.left ? c.left :0 :c.right < h.width ? h.width - c.right :0, 
                        f + l.width > h.width && (d = "left" == d ? "right" :"left", f = 0));
        ...
        function l(a) {
            function e() {
                ...
                a.editable().attachListener(a, "selectionChange", function() {
                    ...
                    d && (c && (c.detachEvent("onresizestart", b), c = null), d.$.attachEvent("onresizestart", b), 
                    c = d.$);
                });
            }
            function b(a) {
            ...
            proto:{
                setData:function(a, e) {
                    ...
                    if (e) this.setHtml(a), b.fire("dataReady"); else {
                        ...
                        d ? (/<body[\s|>]/.test(a) || (a = "<body>" + a), /<html[\s|>]/.test(a) || (a = "<html>" + a + "</html>"), 
    ...
    (function() {
        ...
        function P(a, c, d, b) {
            ...
            }(), f = c.getDocumentPosition(), g = {}, i = {}, h = {}, j = {}, l = t.length; l--; ) g[t[l]] = parseInt(e("border-" + t[l] + "-width"), 10) || 0, 
            h[t[l]] = parseInt(e("padding-" + t[l]), 10) || 0, i[t[l]] = parseInt(e("margin-" + t[l]), 10) || 0;
            (!d || b) && I(a, b);
        ...
        var ca = function() {
            ...
            function a(a) {
                ...
                for (var b = Number.MAX_VALUE, i, h, j, l; f && !f.equals(e) && (h = e.getNext(a.isRelevant)); ) i = Math.abs(ga(a, e, h) - a.mouse.y), 
                i < b && (b = i, j = e, l = h), e = h, o(a, e);
                    ...
                    for (var h = a._.removeFormatRegex || (a._.removeFormatRegex = RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), e = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), f = CKEDITOR.plugins.removeformat.filter, k = a.getSelection().getRanges(), l = k.createIterator(), m = function(a) {
                        ...
                        if (d) {
                            ...
                            for (b = b.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT); b && !b.equals(d); ) if (b.isReadOnly()) {
                                ...
                                b = b.getNext(m);
                            } else i = b.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT), !("img" == b.getName() && b.data("cke-realelement")) && f(a, b) && (h.test(b.getName()) ? b.remove(1) :(b.removeAttributes(e), 
                            a.fire("removeFormatCleanup", b))), b = i;
                        }
                        c.moveToBookmark(j);
                    }
                    a.forceNextSelectionCheck();
